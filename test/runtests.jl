...
srand(124)
Rbeta2	  = rbeta(n, .8, 2)
Rbinom2	  = rbinom(n, 55, pi/16)
Rcauchy2   = rcauchy(n, 12, 2)
Rchisq2	  = rchisq(n, 3)
Rexp2	  = rexp(n, 2)
Rf2	  = rf(n, 12, 6)
Rgamma2	  = rgamma(n, 2, 5)
Rgeom2	  = rgeom(n, pi/16)
Rhyper2	  = rhyper(n, 40, 30, 20)
Rlnorm2	  = rlnorm(n, -1, 3)
Rlogis2	  = rlogis(n, 12, 2)
Rnbinom2   = rnbinom(n, 7, .01)
Rnorm2	  = rnorm(n, -1, 3)
Rpois2	  = rpois(n, 12)
Rsignrank2 = rsignrank(n, 47)

allEq(Rbeta, Rbeta2)
allEq(Rbinom, Rbinom2)
allEq(Rcauchy,	  Rcauchy2)
allEq(Rchisq,     Rchisq2)
allEq(Rexp,	  Rexp2)
allEq(Rf,	  Rf2)
allEq(Rgamma,	  Rgamma2)
allEq(Rgeom,	  Rgeom2)
allEq(Rhyper,	  Rhyper2)
allEq(Rlnorm,	  Rlnorm2)
allEq(Rlogis,	  Rlogis2)
allEq(Rnbinom,	  Rnbinom2)
allEq(Rnorm,	  Rnorm2)
allEq(Rpois,	  Rpois2)
allEq(Rsignrank,  Rsignrank2)
